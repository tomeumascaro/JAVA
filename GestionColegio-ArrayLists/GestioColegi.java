...
//        Box verticalBoxEstud = Box.createVerticalBox();
    ...
    private void llistarCursos(){
        ...
        for (int i = 0; i < llistaCursos.getTamany(); i++) {
            model.addElement(llistaCursos.getCurs(i).getNomCurs());
        }
    ...
    private void llistarAssign(){
        ...
        for (int i = 0; i < llistaAssignatures.getTamany(); i++) {
            model.addElement(llistaAssignatures.getAssignatura(i).getNomAssignatura());
        }
    ...
    private String mostrarAssign(int idx){
        ...
        for (int i = 0; i < llistaCursos.getCurs(idx).getLlistaAssign().getTamany(); i++) {
            res += llistaCursos.getCurs(idx).getLlistaAssign().getAssignatura(i).toString();
        }
        return res;
    }
